  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl text-center relative z-10">
        ...
        <div className="mb-8 flex flex-wrap items-center justify-center gap-6 text-sm font-medium text-white drop-shadow-md dark:shadow-none">
          <span className="flex items-center gap-2"><Shield className="h-4 w-4 text-emerald-400" /> 100% Anonymous</span>
          <span className="h-1.5 w-1.5 rounded-full bg-white/40 dark:bg-slate-950/40" />
        ...
        <h1 className="text-5xl font-semibold tracking-tight sm:text-7xl text-white drop-shadow-xl dark:shadow-none shadow-black">
          A student-led healing movement
        </h1>
        
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/95 drop-shadow-md dark:shadow-none font-medium">
