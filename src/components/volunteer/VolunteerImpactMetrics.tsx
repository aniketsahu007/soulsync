...
export const VolunteerImpactMetrics = memo(({ 
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-2 p-10 rounded-[3rem] border-white/40 bg-navy text-white relative overflow-hidden shadow-2xl dark:shadow-none ring-1 ring-white/10">
        <div className="relative z-10">
          ...
          <div className="mt-16 p-8 rounded-[2rem] bg-white/5 dark:bg-slate-950/5 border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 hover:bg-white dark:bg-slate-950/[0.07] transition-all">
             ...
             <Button className="rounded-xl bg-white dark:bg-slate-950 text-navy hover:bg-slate-100 dark:bg-slate-900 text-[10px] font-black uppercase tracking-[0.2em] px-8 h-12 transition-all active:scale-95">My History</Button>
          </div>
        </div>
      ...
      <div className="space-y-6">
        <div className="p-8 rounded-[3rem] border-white bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl shadow-sm dark:shadow-none border border-white ring-1 ring-slate-200/50">
          <h4 className="font-black text-slate-900 dark:text-slate-50 mb-6 flex items-center gap-2">
        ...
        <div className="p-8 rounded-[3rem] border-none bg-gradient-to-br from-navy to-slate-900 text-white shadow-xl dark:shadow-none group cursor-pointer overflow-hidden relative">
          <div className="relative z-10">
            ...
            <div className="w-full bg-white/10 dark:bg-slate-950/10 h-2 rounded-full overflow-hidden">
